...
const ROUTE_LIB_JS = '/gen/lib.js';
const ROUTE_LIB_CSS = '/gen/lib.css';
...
const defaultRoutes = {
    [ROUTE_LIB_JS]: generate(ROUTE_LIB_JS),
    [ROUTE_LIB_CSS]: generate(ROUTE_LIB_CSS),
...
module.exports = bootstrap(function createServer(options, config, configFile) {
    ...
    utils.process('Init common routes', () => {
        ...
        app.get(ROUTE_LIB_JS, generate(ROUTE_LIB_JS));
        app.get(ROUTE_LIB_CSS, generate(ROUTE_LIB_CSS));
        app.get(ROUTE_SETUP, generate(ROUTE_SETUP, null, options, config, null));
    });
