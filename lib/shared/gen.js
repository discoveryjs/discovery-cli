...
function generateHtml(filepath, modelConfig, config) {
    ...
    let html = fs.readFileSync(path.join(discoveryDir, filepath), 'utf8');
...
module.exports = {
    ...
    '/index.html': function(modelConfig, config) {
        return generateHtml('src/index.html', {}, config);
    },
    '/model-index.html': function(modelConfig, config) {
        return generateHtml('src/model.html', modelConfig, config);
    },
