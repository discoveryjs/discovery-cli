...
function getDataPlaceholder() {
    return '__DISCOVERY_DATA_PLACEHOLDER__';
}

function getModePlaceholder() {
    return '__DISCOVERY_MODE_PLACEHOLDER__';
}

function getSetupModelPlaceholder() {
    return '__DISCOVERY_SETUP_MODEL_PLACEHOLDER__';
}
