...
module.exports = async function(config, options, esbuildConfig, { cacheDispatcher, filter } = {}) {
    ...
    for (const modelConfig of config.models) {
        ...
        files.set(`${slug}/setup.js`, () => gen['/gen/setup.js'](modelConfig, options, config, cacheDispatcher));
    ...
    if (config.mode === 'multi') {
        ...
        files.set('setup.js', () => gen['/gen/setup.js'](null, options, config, cacheDispatcher));
