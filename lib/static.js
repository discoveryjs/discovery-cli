...
module.exports = bootstrap(function genStatic(options, config) {
    return async resolve => {
        ...
        genDataStream.on('end', () => {
            ...
            const js = fs.readFileSync(`${dir}/${model}/model.js`, 'utf8')
                ...
                .replace(new RegExp(`function ${SETUP_MODEL_PLACEHOLDER}\\(\\){return.*?}\\(\\)`), JSON.stringify({ ...config.models[0], download: false, cache: false}))
